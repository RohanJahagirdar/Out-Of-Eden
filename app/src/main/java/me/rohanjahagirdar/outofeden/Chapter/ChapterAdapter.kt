...
class ChapterAdapter(val context: Context, val listener: ChapterRecyclerViewClickListener) : RecyclerView.Adapter<ChapterAdapter.ChapterViewHolder>() {
    lateinit var index: Array<String>
    lateinit var images: Array<String>

    companion object {
        var recyclerViewClickListener: ChapterRecyclerViewClickListener? = null
    }
